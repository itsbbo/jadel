...
type PGStatStatement struct {
	Userid               sql.Null[uint32]          `db:"userid" `
	Dbid                 sql.Null[uint32]          `db:"dbid" `
	Toplevel             sql.Null[bool]            `db:"toplevel" `
	Queryid              sql.Null[int64]           `db:"queryid" `
	Query                sql.Null[string]          `db:"query" `
	Plans                sql.Null[int64]           `db:"plans" `
	TotalPlanTime        sql.Null[float64]         `db:"total_plan_time" `
	MinPlanTime          sql.Null[float64]         `db:"min_plan_time" `
	MaxPlanTime          sql.Null[float64]         `db:"max_plan_time" `
	MeanPlanTime         sql.Null[float64]         `db:"mean_plan_time" `
	StddevPlanTime       sql.Null[float64]         `db:"stddev_plan_time" `
	Calls                sql.Null[int64]           `db:"calls" `
	TotalExecTime        sql.Null[float64]         `db:"total_exec_time" `
	MinExecTime          sql.Null[float64]         `db:"min_exec_time" `
	MaxExecTime          sql.Null[float64]         `db:"max_exec_time" `
	MeanExecTime         sql.Null[float64]         `db:"mean_exec_time" `
	StddevExecTime       sql.Null[float64]         `db:"stddev_exec_time" `
	Rows                 sql.Null[int64]           `db:"rows" `
	SharedBLKSHit        sql.Null[int64]           `db:"shared_blks_hit" `
	SharedBLKSRead       sql.Null[int64]           `db:"shared_blks_read" `
	SharedBLKSDirtied    sql.Null[int64]           `db:"shared_blks_dirtied" `
	SharedBLKSWritten    sql.Null[int64]           `db:"shared_blks_written" `
	LocalBLKSHit         sql.Null[int64]           `db:"local_blks_hit" `
	LocalBLKSRead        sql.Null[int64]           `db:"local_blks_read" `
	LocalBLKSDirtied     sql.Null[int64]           `db:"local_blks_dirtied" `
	LocalBLKSWritten     sql.Null[int64]           `db:"local_blks_written" `
	TempBLKSRead         sql.Null[int64]           `db:"temp_blks_read" `
	TempBLKSWritten      sql.Null[int64]           `db:"temp_blks_written" `
	SharedBLKReadTime    sql.Null[float64]         `db:"shared_blk_read_time" `
	SharedBLKWriteTime   sql.Null[float64]         `db:"shared_blk_write_time" `
	LocalBLKReadTime     sql.Null[float64]         `db:"local_blk_read_time" `
	LocalBLKWriteTime    sql.Null[float64]         `db:"local_blk_write_time" `
	TempBLKReadTime      sql.Null[float64]         `db:"temp_blk_read_time" `
	TempBLKWriteTime     sql.Null[float64]         `db:"temp_blk_write_time" `
	WalRecords           sql.Null[int64]           `db:"wal_records" `
	WalFpi               sql.Null[int64]           `db:"wal_fpi" `
	WalBytes             sql.Null[decimal.Decimal] `db:"wal_bytes" `
	JitFunctions         sql.Null[int64]           `db:"jit_functions" `
	JitGenerationTime    sql.Null[float64]         `db:"jit_generation_time" `
	JitInliningCount     sql.Null[int64]           `db:"jit_inlining_count" `
	JitInliningTime      sql.Null[float64]         `db:"jit_inlining_time" `
	JitOptimizationCount sql.Null[int64]           `db:"jit_optimization_count" `
	JitOptimizationTime  sql.Null[float64]         `db:"jit_optimization_time" `
	JitEmissionCount     sql.Null[int64]           `db:"jit_emission_count" `
	JitEmissionTime      sql.Null[float64]         `db:"jit_emission_time" `
	JitDeformCount       sql.Null[int64]           `db:"jit_deform_count" `
	JitDeformTime        sql.Null[float64]         `db:"jit_deform_time" `
	StatsSince           sql.Null[time.Time]       `db:"stats_since" `
	MinmaxStatsSince     sql.Null[time.Time]       `db:"minmax_stats_since" `
}
