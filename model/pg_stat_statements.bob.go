...
type PGStatStatement struct {
	Userid               null.Val[uint32]          `db:"userid" json:"userid"`
	Dbid                 null.Val[uint32]          `db:"dbid" json:"dbid"`
	Toplevel             null.Val[bool]            `db:"toplevel" json:"toplevel"`
	Queryid              null.Val[int64]           `db:"queryid" json:"queryid"`
	Query                null.Val[string]          `db:"query" json:"query"`
	Plans                null.Val[int64]           `db:"plans" json:"plans"`
	TotalPlanTime        null.Val[float64]         `db:"total_plan_time" json:"total_plan_time"`
	MinPlanTime          null.Val[float64]         `db:"min_plan_time" json:"min_plan_time"`
	MaxPlanTime          null.Val[float64]         `db:"max_plan_time" json:"max_plan_time"`
	MeanPlanTime         null.Val[float64]         `db:"mean_plan_time" json:"mean_plan_time"`
	StddevPlanTime       null.Val[float64]         `db:"stddev_plan_time" json:"stddev_plan_time"`
	Calls                null.Val[int64]           `db:"calls" json:"calls"`
	TotalExecTime        null.Val[float64]         `db:"total_exec_time" json:"total_exec_time"`
	MinExecTime          null.Val[float64]         `db:"min_exec_time" json:"min_exec_time"`
	MaxExecTime          null.Val[float64]         `db:"max_exec_time" json:"max_exec_time"`
	MeanExecTime         null.Val[float64]         `db:"mean_exec_time" json:"mean_exec_time"`
	StddevExecTime       null.Val[float64]         `db:"stddev_exec_time" json:"stddev_exec_time"`
	Rows                 null.Val[int64]           `db:"rows" json:"rows"`
	SharedBLKSHit        null.Val[int64]           `db:"shared_blks_hit" json:"shared_blks_hit"`
	SharedBLKSRead       null.Val[int64]           `db:"shared_blks_read" json:"shared_blks_read"`
	SharedBLKSDirtied    null.Val[int64]           `db:"shared_blks_dirtied" json:"shared_blks_dirtied"`
	SharedBLKSWritten    null.Val[int64]           `db:"shared_blks_written" json:"shared_blks_written"`
	LocalBLKSHit         null.Val[int64]           `db:"local_blks_hit" json:"local_blks_hit"`
	LocalBLKSRead        null.Val[int64]           `db:"local_blks_read" json:"local_blks_read"`
	LocalBLKSDirtied     null.Val[int64]           `db:"local_blks_dirtied" json:"local_blks_dirtied"`
	LocalBLKSWritten     null.Val[int64]           `db:"local_blks_written" json:"local_blks_written"`
	TempBLKSRead         null.Val[int64]           `db:"temp_blks_read" json:"temp_blks_read"`
	TempBLKSWritten      null.Val[int64]           `db:"temp_blks_written" json:"temp_blks_written"`
	SharedBLKReadTime    null.Val[float64]         `db:"shared_blk_read_time" json:"shared_blk_read_time"`
	SharedBLKWriteTime   null.Val[float64]         `db:"shared_blk_write_time" json:"shared_blk_write_time"`
	LocalBLKReadTime     null.Val[float64]         `db:"local_blk_read_time" json:"local_blk_read_time"`
	LocalBLKWriteTime    null.Val[float64]         `db:"local_blk_write_time" json:"local_blk_write_time"`
	TempBLKReadTime      null.Val[float64]         `db:"temp_blk_read_time" json:"temp_blk_read_time"`
	TempBLKWriteTime     null.Val[float64]         `db:"temp_blk_write_time" json:"temp_blk_write_time"`
	WalRecords           null.Val[int64]           `db:"wal_records" json:"wal_records"`
	WalFpi               null.Val[int64]           `db:"wal_fpi" json:"wal_fpi"`
	WalBytes             null.Val[decimal.Decimal] `db:"wal_bytes" json:"wal_bytes"`
	JitFunctions         null.Val[int64]           `db:"jit_functions" json:"jit_functions"`
	JitGenerationTime    null.Val[float64]         `db:"jit_generation_time" json:"jit_generation_time"`
	JitInliningCount     null.Val[int64]           `db:"jit_inlining_count" json:"jit_inlining_count"`
	JitInliningTime      null.Val[float64]         `db:"jit_inlining_time" json:"jit_inlining_time"`
	JitOptimizationCount null.Val[int64]           `db:"jit_optimization_count" json:"jit_optimization_count"`
	JitOptimizationTime  null.Val[float64]         `db:"jit_optimization_time" json:"jit_optimization_time"`
	JitEmissionCount     null.Val[int64]           `db:"jit_emission_count" json:"jit_emission_count"`
	JitEmissionTime      null.Val[float64]         `db:"jit_emission_time" json:"jit_emission_time"`
	JitDeformCount       null.Val[int64]           `db:"jit_deform_count" json:"jit_deform_count"`
	JitDeformTime        null.Val[float64]         `db:"jit_deform_time" json:"jit_deform_time"`
	StatsSince           null.Val[time.Time]       `db:"stats_since" json:"stats_since"`
	MinmaxStatsSince     null.Val[time.Time]       `db:"minmax_stats_since" json:"minmax_stats_since"`
}
