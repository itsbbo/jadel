...
// WithGlobalShareProps returns Option that will set Inertia's global shared props.
func WithGlobalShareProps(props Props) Option {
	return func(i *Inertia) error {
		i.sharedProps = props
		return nil
	}
...
// WithGlobalShareProp returns Option that will set Inertia's global shared prop.
func WithGlobalShareProp(key string, value any) Option {
	return func(i *Inertia) error {
...
// WithGlobalTemplateData returns Option that will set Inertia's global shared template data.
func WithGlobalTemplateData(data TemplateData) Option {
	return func(i *Inertia) error {
		i.sharedTemplateData = data
		return nil
	}
}

// WithGlobalTemplateFuncs returns Option that will set Inertia's global shared template funcs.
func WithGlobalTemplateFuncs(funcs TemplateFuncs) Option {
	return func(i *Inertia) error {
		i.sharedTemplateFuncs = funcs
		return nil
	}
}
